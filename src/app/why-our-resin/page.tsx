...
export const metadata: Metadata = {
  ...
  description:
    "Hand-sorted grading, higher oil content, traditional harvesting, and direct sourcing from Puntland — what actually makes our myrrh premium.",
...
const features: {
...
}[] = [
  {
    ...
    imageKind: "process",
    imageSrc: "/images/myrrh-resin-bowl.jpg",
  },
  {
    title: "Premium grades, clearly defined",
    body: "We grade on three things you can see: tear size, color, and clarity. Larger, paler, more translucent tears generally indicate a cleaner tap and slower, more careful drying. Here's how our three grades compare.",
    imageCaption: "Myrrh resin tears on bark, showing the range of size and color our grades are built on.",
    imageKind: "macro",
    imageSrc: "/images/myrrh-bark-tears.jpg",
    reverse: true,
  },
  {
    title: "Higher oil content",
    body: "Commiphora trees growing in Puntland's arid, high-altitude climate produce resin with notably high aromatic oil content — the compounds responsible for aroma strength and burn quality. We're working toward publishing lab-verified oil content data per batch; for now, our grading reflects harvester and buyer experience matching tear appearance to burn quality, refined over years of sourcing from the same trees and families.",
    imageCaption: "Myrrh essential oil, distilled from raw resin tears.",
    imageKind: "macro",
    imageSrc: "/images/myrrh-essential-oil.png",
  },
  {
    ...
    imageCaption: "Close-up bark texture of a Commiphora trunk, the tree tapped for myrrh.",
    imageKind: "portrait",
    imageSrc: "/images/tree-bark-texture.jpg",
    reverse: true,
  },
  {
    title: "Cleaner resin",
    ...
    imageCaption: "Sorted myrrh tears, free of bark and dust, ready for packaging.",
    imageKind: "packaging",
    imageSrc: "/images/myrrh-resin.png",
  },
  {
    ...
    imageCaption: "Sacks of raw goods at a Puntland trading market, the kind of scene resin passes through before export.",
    imageKind: "landscape",
    imageSrc: "/images/puntland-market-sacks.jpg",
    reverse: true,
  },
];
